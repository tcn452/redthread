...
We begin every engagement with an introductory conversation to ensure there is genuine alignment between your goals and our coaching practice.

1. **Exploratory Conversation (15 Minutes)**: A focused, complimentary conversation to discuss your context, current leadership challenges, and objectives.
2. **Tailored Coaching Agreement**: A clear, structured agreement specifying session cadence (typically 6 to 12 bi-weekly sessions), key milestones, and qualitative success measures.
3. **Deep Transformative Practice**: Rigorous, supportive, and practical coaching sessions supported by between-session exercises and check-ins.
